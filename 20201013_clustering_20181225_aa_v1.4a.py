...
def getClusteredData(args):
		...
		kmeans = KMeans(n_clusters= num_clusters, n_init = 12, max_iter = 300, random_state = 0, verbose=False).fit(windows)
...
#	getClusteredData(num_clusters,windows, k, dist_vs_num_clusters, dir_string)
	pool.map(getClusteredData, zip(nClusters,
